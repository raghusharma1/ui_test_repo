...
class DashboardPage(BasePage):
    ...
    _RECENT_LIST_ITEM = resource_id("dashboard_recent_item_card") # Add a locator for individual list items
    ...
    def count_recent_list_items(self):
        ...
        # Count specific list item elements within the container
